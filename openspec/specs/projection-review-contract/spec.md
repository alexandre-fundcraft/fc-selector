# projection-review-contract Specification

## Purpose
Ensure consistent nested alias and property projection, controlled related-field validation, and meaningful API error regression coverage.
