...
SECRET_KEY = "django-insecure-example-key-for-development-only"  # nosec B105 - Example/development only
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Blog API with OData Support",
    "DESCRIPTION": "A read-only API with full OData query support ($filter, $select, $expand, $orderby, $top, $skip)",
    "VERSION": "1.0.0",
    "SERVE_INCLUDE_SCHEMA": False,
    "COMPONENT_SPLIT_REQUEST": True,
    "TAGS": [
        {"name": "posts", "description": "Blog post operations with OData support"},
        {"name": "authors", "description": "Author operations"},
        {"name": "users", "description": "User operations (password excluded)"},
