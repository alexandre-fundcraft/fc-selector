...
from fc_selector.core.parsers.filter import ast, typing, utils
from fc_selector.core.parsers.filter import exceptions as ex
from fc_selector.core.parsers.filter.ast import visitor
...
class AstToDjangoQVisitor(visitor.NodeVisitor):
    ...
    def djangofunc_substring(
        self, fullstr: ast._Node, index: ast._Node, nchars: ast._Node | None = None
    ) -> functions.Substr:
        ":meta private:"
